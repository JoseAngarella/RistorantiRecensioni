...
$dbnameDB = "ristorante_recensioni"; // Qui bisogna cambiare con il nome del database presente su phpMyAdmin
...
if ($conn->connect_error) {
  header("Location: errore_connessione.html");  // Se la connessione NON va a buon fine, faccio un redirect a una pagina di errore
}
?>
